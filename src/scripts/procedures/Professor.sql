...
SELECT public.DeletarFuncoes('Administracao', 'SelecionarProfessorSimples');
CREATE OR REPLACE FUNCTION Administracao.SelecionarProfessorSimples()
    RETURNS TABLE(
        "id"        INTEGER,
        "nome"      VARCHAR,
        "sobrenome" VARCHAR
...
/*
    SELECT * FROM Administracao.SelecionarProfessorSimples();
*/
